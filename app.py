...
with ui.sidebar(open="open"):
    ...
    ui.h2("Denver in April", class_="text-center")
    ui.p(
        "A demonstration of real-time temperature readings in Denver.",
        class_="text-center",
    )
    ui.hr()
    ui.h6("Links:")
    ui.a(
        "GitHub Source",
        href="https://github.com/Tezzyray/cintel-05-cintel",
        target="_blank",
    )
    ui.a(
        "GitHub App",
        href="https://Tezzyray.github.io/cintel-05-cintel/",
        target="_blank",
    )
